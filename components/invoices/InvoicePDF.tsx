...
import { Invoice } from "@/lib/features/invoice/invoiceSlice";
      ...
      <div style={styles.header}>
        ...
        <div style={styles.headerFlex}>
          ...
          <div style={{ ...styles.smallText, ...styles.rightAlign }}>
            ...
            <p>
              <strong>Taluka:</strong> {invoice.taluka || "_________"}
            </p>
            <p>
              <strong>Dist.:</strong> {invoice.dist || "_________"}
            </p>
          </div>
        </div>
        ...
        <div style={styles.divider}>
          ...
          <p style={styles.smallText}>
            <strong>Consignee:</strong> {invoice.consignee}
          </p>
          <p style={styles.smallText}>
            <strong>Invoice No.:</strong> {invoice.invoiceNo}{" "}
            <strong>Co.D.O.No.:</strong> _________
          </p>
        </div>
        ...
        <table style={styles.table}>
          <thead>
            <tr style={styles.tableHeader}>
              ...
              <th style={styles.tableCell}>HSN No.</th>
              ...
              <th style={styles.tableCell}>CGST/SGST</th>
          ...
          <tbody>
            {invoice.rows.map((row, index) => (
              <tr key={index}>
                ...
                <td style={styles.tableCell}>{row.hsnNo}</td>
                ...
                <td style={styles.tableCell}>₹{row.cgstSgst}</td>
